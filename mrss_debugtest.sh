...
#
#curl http://127.0.0.1:9000/loadmodel -X POST -H "Content-Type: application/json" -d '{"model_filename":"/home/client/Projects/RWKV-LM-RLHF/v6/myfolder/Outputs/3B-RLHF-DPO-Bancho/rwkv-23-merged.pth","model_viewname":"RWKV x060 3B Bancho DPO","model_strategy":"nf4"}'
...
#curl http://127.0.0.1:9000/loadmodel -X POST -H "Content-Type: application/json" -d '{"model_filename":"/home/client/Projects/RWKV-LM-RLHF/v6/myfolder/Outputs/7B-RLHF-DPO/rwkv-9-merged.pth","model_viewname":"RWKV x060 7B JPN DPO","model_strategy":"fp8"}'

#curl http://127.0.0.1:9000/loadmodel -X POST -H "Content-Type: application/json" -d '{"model_filename":"/home/client/Projects/RWKV-LM-RLHF/v6/myfolder/Outputs/7B-RLHF-DPO-CHN/rwkv-5-merged.pth","model_viewname":"RWKV x060 7B CHN DPO","model_strategy":"fp8"}'
...
#curl http://127.0.0.1:9000/loadstatemodel -X POST -H "Content-Type: application/json" -d '{"state_filename":"/home/client/Projects/RWKV-LM-State-4bit-Orpo/v6-state-4bit/20241021_3BOrpo/rwkv-5.pth","state_viewname":"bancho","default_temperature":"1.0", "default_top_p":"0.3"}'
