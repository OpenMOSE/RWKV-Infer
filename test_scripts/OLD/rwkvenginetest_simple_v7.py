...
if __name__ == '__main__':
    ...
    model = RWKV_x('/home/client/Projects/RWKV-LM-RLHF/main/myfolder/models/RWKV-x070-World-1.5B-v3-20250127-ctx4096.pth','bf16') #bf16, fp8, fp6, fp5
    Target_batch = 1#args.tb#16

    States = model.new_state(Target_batch)#state_empty(32, 1, 2560, 2560 // 32)

    #Input Context 
    context =  'User: あなたが望むものは何がある？\n\n\x17Assistant:'
    ...
    state_tuned_wkv = model.load_state('/home/client/Projects/RWKV-LM-RLHF/main/myfolder/Outputs/x070-1b5-big-prefix/rwkv-3-state.pth')
