...
if __name__ == '__main__':
   ...
   # decoded = pipeline.decode(text)
    ...
    messages = [
        ...
        {'role':'assistant', 'content':"orwwa genki"},
    ]
    ...
    model = RWKV_x('models/PRWKV-7-rekaflash3-stage2p-ffnaligned.pth','fp5',
                   adapter_model='adapters/rekaflash3-stage3-5.pth',
                   adapter_mode='bone',
        ...
        for i in range(maxtoken):
            ...
            #         pass
                try:
                    ...
                    # if "<reasoning>" in diff_text:
                    #     otokens[j] = pipeline.decode("</reasoning>")
                    #     out_tokens[j][-1] += pipeline.decode("</reasoning>")
                    #     exit()
                    ...
                    # if output_text[j].endswith("<reasoning>"):
                    #     otokens[j] = pipeline.decode("</reasoning>")
                    #     out_tokens[j][-1] += pipeline.decode("</reasoning>")
                    #     exit()
