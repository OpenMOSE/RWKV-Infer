        ...
        with torch.no_grad(): 
            ...
            for i in range(self.n_layer):
                ...
                if StrategyMode == 0: 
                        ...
                        xx, time_mix_shift, time_mix_state, v_first = PRWKV_7.cxa075_TimeMix_fla_Step3(B,T,self.n_head,self.head_size,r,k,z[att+'r_k'],v,z[att+'output.weight'],torch.tensor(0.0,dtype=xx.dtype),
