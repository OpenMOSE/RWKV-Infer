...
args.tokenizer = "rwkv/rwkv_vocab_v20230424.txt"
# args.MODEL_NAME = '/home/rwkv/rwkv-final-v6-2.1-3b'
# args.MODEL_NAME = '/mnt/program/rwkv-final-v6-2.1-3b'
args.MODEL_NAME = 'models/RWKV-x060-World-3B-v2.1-20240417-ctx4096'
args.n_layer = 32
args.n_embd = 2560
args.vocab_size = 65536
args.head_size = 64

context = "User: tell me stories about computer science. \n\nAssistant:"
# context = "\n北京"
NUM_TRIALS = 1
...
tokenizer = RWKV_TOKENIZER(args.tokenizer)
