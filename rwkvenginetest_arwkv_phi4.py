...
if __name__ == '__main__':
   ...
   #exit()
    ...
    model = RWKV_x('/home/client/Projects/RWKV-LM-RLHF/main/myfolder/models/rwkv-phi4-mini-instruct-stage2.pth','fp16',
                   adapter_model='/home/client/Projects/RWKV-LM-RLHF/main/myfolder/Outputs/pxa070-phi4-mini2/rwkv-6.pth',
                   adapter_mode='lora',
